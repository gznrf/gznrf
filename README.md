...
| ![](https://github.com/gznrf/gznrf/raw/main/dancing-gopher.gif) | **Привет👋 Меня зовут Иван!**  |
|--------------------------------------------------|-----------------------|
| Это текст, который будет отображаться справа от GIF. Вы можете добавить сюда любое содержание, которое вам нужно. Дополнительная информация или описание проекта могут быть размещены здесь. |
